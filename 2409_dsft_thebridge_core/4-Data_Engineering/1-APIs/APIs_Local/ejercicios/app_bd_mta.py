...
# Configurar el directorio base para asegurar la correcta localización de books.db
...
def query_db(query, args=(), one=False):
    db_path = os.path.join(BASE_DIR, "books.db")  # Ruta absoluta a la base de datos
