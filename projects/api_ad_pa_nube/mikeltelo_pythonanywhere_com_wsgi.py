...
# web application at http://mikeltelo.pythonanywhere.com/
...
#import sys
#
#path = '/home/mikeltelo/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/mikeltelo/mysite/mysite/settings.py'
## and your manage.py is is at '/home/mikeltelo/mysite/manage.py'
#path = '/home/mikeltelo/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
import sys
#
## The "/home/mikeltelo" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/mikeltelo/myproject"
path = '/home/mikeltelo/api_nube'
if path not in sys.path:
    sys.path.append(path)
#
