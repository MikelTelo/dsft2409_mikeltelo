...
root_path = "/home//mikeltelo/api_nube/"
...
def hello(): #Ligado al endpoint "/" o sea el home, con el metodo GET
    return "Bienvenido a mi API del modelo advertising ya terminado 22"
